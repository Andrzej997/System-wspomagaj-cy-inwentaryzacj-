...
public class TutorialView extends JPanel {
    ...
    private void initComponents() {
        initObjects();
        try {
            Image img = ImageIO.read(TutorialView.class.getResource("/resources/left.png"));
            ButtonStyle.setStyle(prevBtn, img);
            Image img2 = ImageIO.read(TutorialView.class.getResource("/resources/right.png"));
    ...
    private void setupTutorial() throws IOException {
        ...
        switch (counter) {
            case 0:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/1.png"));
                ...
                break;
            case 1:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/2.png"));
                textLabel.setText("<html>Here is your menu. Grey options aren't available for you.</html>");
                break;
            case 2:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/3.png"));
                textLabel.setText("<html>Week view. You can check your plan here.</html>");
                break;
            case 3:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/day.png"));
                textLabel.setText("<html>When you click on day name you can enter day data view.</html>");
                break;
            case 4:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/4.png"));
                textLabel.setText("<html>Choose your date!</html>");
                break;
            case 5:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/5.png"));
                textLabel.setText("<html>Click on reservation area to enter edit mode.</html>");
                break;
            case 6:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/6.png"));
                textLabel.setText("<html>Choose reservtion to edit. Don't worry, we will remind you it is required :)</html>");
                break;
            case 7:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/7.png"));
                textLabel.setText("<html>Click on 'add reservation' to add new reservation</html>");
                break;
            case 8:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/8.png"));
                ...
                break;
            case 9:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/10.png"));
                textLabel.setText("<html>Change your password to protect your data.</html>");
                break;
            case 10:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/12.png"));
                textLabel.setText("<html>At the end of the work remember to logout!</html>");
                break;
            case 11:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/13.png"));
                textLabel.setText("<html>Sometimes you can get lost, when there are so many options...</html>");
                break;
            case 12:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/back.png"));
                textLabel.setText("<html>...but you can always go back!</html>");
                break;
            case 13:
                myPicture = ImageIO.read(TutorialView.class.getResource("/resources/14.png"));
